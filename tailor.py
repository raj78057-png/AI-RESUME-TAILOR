...
- Keep ALL facts true — never invent skills or projects
- Remove ANY work experience, internships, or job history completely
- Focus ONLY on Skills, Projects, and Education
- Strengthen project bullet points with action verbs + measurable impact
- Add a tight 2-line Summary aligned to the role
- Order Skills to front-load JD keywords
- Remove certificates, achievements, and irrelevant content
- Limit resume to ONE PAGE (concise, high-impact content only)
- Use clean Markdown formatting
- Output ONLY the final 1-page Markdown resume — no explanation, no fences
"""
USER_TEMPLATE = """JD:
{jd}
